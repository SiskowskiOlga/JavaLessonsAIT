...
public class HobbyUtil {
    //создаем массив строк список хобби
    private static String[]hobbies = {"рисование","плавание","спорт","медитация"};
    private static int[]ratings = {10,5,40};
    static Scanner scanner = new Scanner(System.in); //читает и выводит
