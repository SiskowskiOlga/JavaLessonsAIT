...
для логирования действий пользователя.
 Приложение должно запросить у пользователя ввести его имя,
 возраст и любимый цвет, после чего залогировать эти данные.
